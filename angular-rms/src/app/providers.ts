...
export const lookupLists = {
    nationality : [{value:'INDONESIAN',viewValue:'INDONESIAN'},{value:'AUSTRALIAN',viewValue:'AUSTRALIAN'},{value:'VIETNAMESE',viewValue:'VIETNAMESE'},{value:'SINGAPOREAN',viewValue:'SINGAPOREAN'}],
